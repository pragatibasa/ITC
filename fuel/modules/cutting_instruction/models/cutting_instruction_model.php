...
class Cutting_instruction_model extends Base_module_model {
 ...
 function savechange(){
	...
	$sql = $this->db->query ("UPDATE aspen_tblinwardentry SET vprocess='Cutting', machineNo=".$_POST['machineNo'].",cuttingDate='".$_POST['cutting_date']."', vStatus='Work In Progress' WHERE vIRnumber='".$_POST['pid']."'");
