...
function pullFolders(selectedItem) {
	...
	$.post('<?php echo fuel_url("rate_details_width/coil"); ?>',
...
<?php include_once(RATE_DETAILS_WIDTH_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(RATE_DETAILS_WIDTH_PATH.'views/_blocks/layout.php');?>		
